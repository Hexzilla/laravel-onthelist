<div class="quixnav">
    <div class="quixnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li class="{{ request()->routeIs('user.event.*') ? 'active' : '' }}"><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="mdi mdi-account"></i><span class="nav-text">Events</span></a>
            ...
            <li class="{{ request()->routeIs('user.venue.*') ? 'active' : '' }}"><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="mdi mdi-home-map-marker"></i><span class="nav-text">Venues</span></a>
                <ul aria-expanded="false">
                    <li><a href="javascript:void()">All</a></li>
                    <li><a href="javascript:void()">Favourite</a></li>
                </ul>
            ...
            <li class="{{ request()->routeIs('user.dj.*') ? 'active' : '' }}"><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i class="mdi mdi-account"></i><span class="nav-text">Djs</span></a>
                <ul aria-expanded="false">
                    <li><a href="javascript:void()">All</a></li>
                    <li><a href="javascript:void()">Favourite</a></li>
                </ul>
