                                    ...
                                    <tr>
                                        <th>
                                            <div class="form-group">
                                                <button type="button" class="btn btn-primary"><a href="{{ route('admin.djs.create') }}">Add Dj</a></button>
                                            </div>
                                        </th>
                                    </tr>
                                    <tr>
...
<div class="modal fade" id="modal_approve_v2">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Approve Dj</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                </button>
            </div>
            <div class="modal-body" style="color:black">Are you sure you want to approve this dj?</div>
            <div class="modal-footer">
                <button type="button" class="btn btn-info">
                    <a href="$URL">Yes</a>
                </button>
...
<div class="modal fade" id="modal_reject_v2">
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Reject Dj</h5>
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                </button>
            </div>
            <div class="modal-body" style="color:black">Are you sure you want to reject this dj?</div>
            <div class="modal-footer">
                <button type="button" class="btn btn-info">
                    <a href="$URL">Yes</a>
                </button>
...
@section('scripts')
    <script>
        const openApproveModal = (user_id) => {
            let url = "{{ route('admin.djs.approve', 0) }}";
        ...
        const openRejectModal = (user_id) => {
            let url = "{{ route('admin.djs.reject', 0) }}";
            url = url.substr(0, url.length-1) + user_id;
