        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-12 p-md-0 justify-content-sm-start mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Dj {{ $user->name }}</a></li>
                </ol>
            </div> 
        </div>
        <div class="row mt-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row  mb-5 mt-3">
                            <h3 class="text-center m-auto">{{$user->name}}</h3>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-sm-12 col-md-8 col-lg-6">
                                <h5 class="float-left">FULL NAME</h5>
                        ...
                        <div class="row justify-content-center mb-5">
                            <div class="col-sm-12 col-md-8 col-lg-6">
                                ...
                                <h5 class="float-right">{{$user->email}}</h5>
                            </div>
                        </div>
